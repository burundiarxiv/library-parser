...
class ParserTest < Minitest::Test
  ...
  def test_extract_content_chap_2_1_4
    test_extract_chapter('chap-2-1-4')
  end

  def test_extract_content_chap_2_1_5
    test_extract_chapter('chap-2-1-5')
  end

  def test_extract_content_chap_2_1_6
    test_extract_chapter('chap-2-1-6')
  end

  def test_extract_content_chap_2_1_7
